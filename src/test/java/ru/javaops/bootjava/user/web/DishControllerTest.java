...
import static ru.javaops.bootjava.user.DishTestData.*;
import static ru.javaops.bootjava.user.DishTestData.getNew;
import static ru.javaops.bootjava.user.DishTestData.getUpdated;
import static ru.javaops.bootjava.user.UserTestData.*;
import static ru.javaops.bootjava.user.web.DishController.REST_URL;
